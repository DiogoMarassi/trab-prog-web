    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('ATIVO', 'Ativo'), ('MANUTENCAO', 'Em Manutenção'), ('INATIVO', 'Inativo')], default='ATIVO', max_length=20, verbose_name='Status Operacional')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('MEDICO', 'Médico'), ('ENGENHEIRO', 'Engenheiro/Administrador')], default='MEDICO', max_length=20, verbose_name='Perfil de Acesso')),
