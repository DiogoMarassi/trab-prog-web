...
urlpatterns = [
    ...
    path('suprimentos/novo/', views.SuprimentoCreateView.as_view(), name='suprimento_create'),
    path('suprimentos/editar/<int:pk>/', views.SuprimentoUpdateView.as_view(), name='suprimento_edit'),
    path('suprimentos/excluir/<int:pk>/', views.SuprimentoDeleteView.as_view(), name='suprimento_delete'),
